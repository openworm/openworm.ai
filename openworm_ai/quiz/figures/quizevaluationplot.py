...
file_paths = {
    "General Knowledge": "openworm_ai/quiz/scores/llm_scores_general.json",
    "Science": "openworm_ai/quiz/scores/llm_scores_science.json",
    "C. Elegans": "openworm_ai/quiz/scores/llm_scores_celegans.json"
}
