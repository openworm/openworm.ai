...
|-|-|-|-|
|\*\*ChaT\*\*\*cha-1\*|\*\*GAD\*\*\*unc-25\*|\*\*VGluT\*\*\*eat-4\*||
|\*\*VAChT\*\*\*unc-17\*|\*\*VGAT\*\*\*unc-47\*|||
|\*\*CHT1\*\*\*cho-1\*|\*\*GAT\*\*\*snf-11\*|||
|||||
|Serotonergic neurons|Tyraminergic neurons|Octopaminergic neurons|Dopaminergic neurons|
|\*\*TPH\*\*\*tph-1\*|\*\*TDC\*\*\*tdc-1\*|\*\*TDC\*\*\*tdc-1\*|\*\*TH\*\*\*cat-2\*|
|\*\*AAAD\*\*\*bas-1\*|\*\*VMAT\*\*\*cat-1\*|\*\*TBH\*\*\*tbh-1\*|\*\*AAAD\*\*\*bas-1\*|
|\*\*VMAT\*\*\*cat-1\*||\*\*VMAT\*\*\*cat-1\*|\*\*VMAT\*\*\*cat-1\*|
|\*\*SERT\*\*\*mod-5\*|\*\*OCT\*\*\*oct-1\*||\*\*DAT\*\*\*dat-1\*|

|eat-4|eat-4|eat-4|
|-|-|-|
|threshold4|OLQ, OLQ, URY, I2, VC\_4\_5, ALV, IL1, RIC, BAG, PVR, PVC, M4, ALM, RIA, PHB, M3, ADA, AWC\_OFF, ASE\_L, ASH, I5, AIB, AWC\_ON, RIM, RIG, ADL, AVN, FLP, PQR, MI, VB01, AFD, SMB, AQR, RIV, ASK, DVA, PLM, I6, ASG, PHA, AVA, AVM, RMD\_LR, RMD\_DV, M5, URB, PVM, IL2\_DV||
|3|||
|2|||
|1|||

|unc-17|unc-17|unc-17|
|-|-|-|
|threshold4|DA, AS, DB, SAB, VC\_4\_5, DA9, VB, VC, M4, IL2\_LR, DVB, PDA, SIA, PVC, RME\_DV, RMD\_LR, SIB, RIH, MC, ALN, M5, URA, RIF, AVD, IL2\_DV, VB01, SMB, M2, SMB, VB02, RIV, RIP, RDE, AIA, I1, I3, SAA, RIR, AIY, HSN, AVE, PVP, PVR, URB, RMH, PLN, AIN, ASU, RID, LUA, AWA, PDB, AWC\_CEP, ASEL, PVQ, AIM, AQR, AVH, AUA, RIM, DVB, RIA, RME\_DV, RIC, AVF||
|3|||
|2|||
|1|||

|unc-25|unc-25|unc-25|unc-47|unc-47|unc-47|
|-|-|-|-|-|-|
|threshold4|VD\_DD, RME\_LR, RME\_DV, DVB, AVL, RIS, RIB, PAV, AWA||DVB, VD, AVL, RME\_LR, RME\_DV, SIA, RIS, SDQ, RIF, DVC, URX, AVG, FLP, I3, I6, DVA, M2, M1, NSM, SMB, M1, RID, PVT|||
|3||||||
|2||||||
|1||||||

|tph-1|tph-1|tph-1|bas-1|bas-1|bas-1|cat-1|cat-1|cat-1|cat-2|cat-2|cat-2|tdc-1|tdc-1|tdc-1|tbh-1|tbh-1|tbh-1|
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
|threshold4|HSN, NSM, ADF, AFD, M1, I1, VC\_4\_5||HSN, NSM, PDE, CEP, ADE, ADF, PVM, PVT||PDE, NSM, RIM, RIL, NEN, VC\_4\_5, RIC, RIF, ADF, ADE, CAN, CEP, AVM, BAG, ASI, AGR, AWC\_OFF, PVR, AVL, PVT||PDE, CEP, ADE, OLL||RIM, RIC, M3, RMG||RIC, PDA, IL2\_LR, IL2\_DV, BAG|||||||
|3||||||||||||||||||
|2||||||||||||||||||
|1||||||||||||||||||
...
|Glutamate|syb4257 T2A GFP H2B|
|-|-|
|eat-4|ZK512.6a.1 9,137,500 9,140,000 9,142,500|
||ZK512.6b.1|
||eat-4 (ZK512.6)|
||ZK512.7.1 ZK512.2a.1|
||ZK512.7 ZK512.2b.1|
||ZK512.2|
|Acetylcholine|syb4491 H2B GFP T2A|
|unc-17|ZC416.8b.1 3,615,000 3,620,000 3,625,000|
||cha-1 (ZC416.8)|
||ZC416.8a.1|
||unc-17 (ZC416.8)|
|GABA|ot1372 T2A GFP H2B|
|unc-25|Y37D8A.23a.1|
||Y37D8A.23b.1|
||Y37D8A.23c.|
||unc-25 (Y37D8A.23)|
||ot1536|
|unc-47|H2B GFP SL2 syb7566|
||T20G5.6.1|
||unc-47 (T20G5.6)|
|unc-46 6|H2B GFP SL2 syb7278 srab-1 (C04F5.4)|
|)||
||C04F5.3.1 C04F5.4.1|
|1||
||unc-46 (C04F5.3)|
|Monoamine|syb6486 H2B GFP SL2|
|cat-1 -1|W01C8.12 E03E2.11 E03E2.t2|
||W01C8.12 E03E2.t1 E03E2.t2|
||W01C8.6.1|
||W01C8.6.2|
||cat-1 (W01C8.6)|
|Serotonin (5-HT)|syb6451 SL2 GFP H2B|
|tph-1|ZK1290.2a.1 7,550,000 7,551,250|
||ZK1290.2b.1|
||tph-1 (ZK1290.2)|
||ZK1290.18 21ur-14885 (ZK1290.17) ZK1290.10.1|
||ZK1290.18 ZK1290.10 ZK1290.19|
||ZK1290.19|
|mod-5|mNeonGreen T2A vlc47|
|7||
||mod-5|
|Dopamine (DA)|syb8255 SL2 GFP H2B|
|cat-2 -2|cat-2|
|Octopamine amine|H2B GFP SL2 syb7786|
|tbh-1 h-1|H13N06.7.1 H13N06.7|
|7||
||H13N06.6a.1|
||H13N06.6b.1|
||H13N06.6c.1|
||tbh-1 (H13N06.6)|
|Tyr+Oct +Oct|GFP H2B T2A syb7768|
|tdc-1|tdc-1 (K01C8.3) K01C8.3a.1 K01C8.3b.1|
||KO1C8.5.1|
||K01C8.5.2|
|2||
||gei-14 (K01C8.5)|
|oct-1|H2B GFP SL2 syb8870|
||oct-1|
|5-HT+DA +DA|syb5923 SL2 GFP H2B|
|bas-1 -1|C05D2.4a.1 C05D2.3.1|
||C05D2.4b.1 basl-1 (C05D2.3)|
||bas-1 (C05D2.4)|
|betaine|syb7290 TagRFP SL2 GFP H2B pho-14|
|snf-3|snf-3|
...
|AFD|AFDL/R|Glu, ACh|
|AIA|AIAL/R|ACh|
|AIB|AIBL/R|Glu, ACh, 5-HT (up)|
|AIM|AIML/R|Glu, 5-HT (up)|
|AIN|AINL/R|ACh|
|AIY|AIYL/R|ACh, \*betaine (up)|
|AIZ|AIZL/R|Glu|
|ALA|ALA/R|GABA|
|ALM|ALML/R|Glu|
|ALN|ALNL/R|ACh|
...
|PVD|PVDL/R|Glu|
|PVM|PVM|orphan|
|PVN|PVNL/R|ACh, \*betaine (up)|
|PVP|PVPL/R|ACh|
|PVQ|PVQL/R|orphan|
|PVR|PVR|Glu|
|PVT|PVT|orphan, unc-47 (+)|
|PVW|PVWL/R|orphan, unc-46 (+)|
|RIA|RIAL/R|Glu|
|RIB|RIBL/R|GABA|
...
|CLASS|NEURON|NEUROTRANSMITTER(S)|
|-|-|-|
|CEM|CEMDL/DR/VL/VR|ACh, 5-HTP, unknown MA?|
...
See Supplementary Files 2  2 & 3 and Tables 1  Tables 1 & 2 for gene expression details, neurotransmitter assignment rationale, and updates in this paper compared to prior studies. See Supplementary File 4 for sexually dimorphic expression of reporter alleles in sex-shared neurons.
...
*Note: The following table represents the data points from the diagram in Figure 3B, organized by neuron location relative to the hermaphrodite body plan shown.*

|Location / Neuron Group|Neurotransmitters Present|Notes|
|-|-|-|
|\*\*Head (Anterior)\*\*|Acetylcholine, GABA, Glutamate, 5-HT or 5-HTP, Tyramine, Octopamine, Dopamine, Betaine|High density of mixed neurotransmitters.|
|\*\*Pharynx\*\*|Acetylcholine, GABA, Glutamate, 5-HT or 5-HTP, Tyramine, Octopamine, Dopamine, Betaine|Mixed population.|
|\*\*Ventral Cord (Anterior)\*\*|Acetylcholine, GABA, Glutamate, 5-HT or 5-HTP, Tyramine, Octopamine, Dopamine, Betaine|Segmented pattern.|
|\*\*Ventral Cord (Posterior)\*\*|Acetylcholine, GABA, Glutamate, 5-HT or 5-HTP, Tyramine, Octopamine, Dopamine, Betaine|Segmented pattern.|
|\*\*Dorsal Cord\*\*|Acetylcholine, GABA, Glutamate, 5-HT or 5-HTP, Tyramine, Octopamine, Dopamine, Betaine|Segmented pattern.|
|\*\*Tail\*\*|Acetylcholine, GABA, Glutamate, 5-HT or 5-HTP, Tyramine, Octopamine, Dopamine, Betaine|Distinct clusters.|
|\*\*Sex-specific neurons\*\*|Various|Marked as sex-specific in legend.|
|\*\*Sex-shared neurons\*\*|Various|Marked as sex-shared in legend.|

\*\*Legend:\*\* \* ● acetylcholine \* ● GABA \* ● glutamate \* ● 5-HT or 5-HTP \* ● tyramine \* ● octopamine \* ● dopamine \* ● betaine \* p may transmit phenylethanolamine \* ● unknown monoamine (incl. bas-1-dependent) \* ● orphan \* u neuron has neurotransmitter uptake capacity \* \* gene expression dim and variable \* alt alternative synthesis and/or uptake mechanism(s) \* sex-shared neuron \* sex-specific neuron
...
|eat-4CRISPR::gfp|NeuroPAL|MERGE|
|-|-|-|
|lateral viewHERM HEADASK ADL M5RIC|ASK ADL M5RIC|ASK ADL M5RIC|

|HERM MIDBODY|HERM TAIL|MALE TAIL|
|-|-|-|
|eat-4CRISPR::gfpPDE PVD|DVC PVQ (-)DVA PHA(+/-)|PVNPVN|
|NeuroPALPDE PVD|DVC PVQDVA PHA|PVNPVN|
|MERGEPDE PVD|DVC PVQDVA PHA|PVNPVN|
...
|-|-|-|
|lateral viewHERM HEADRIP AWA(+/-) AVJ(-)AFD RIB(-) FLP(-)(+)|RIP AWA AVJAFD RIBFLP|RIP AWA(+/-) AVJ(-)AFD RIB(-) FLP(-)(+)|
|AIM AIY AVGlateral view|AIM AIY AVG|AIM AIY AVG|
|MALE HEADAIM AIY AVGlateral view|AIM AIY AVG|AIM AIY AVG|

|unc-17CRISPR::gfp|NeuroPAL|MERGE|
|-|-|-|
|HERM TAILPVNlateral view|PVN|PVN|
|MALE TAILPVNlateral view|PVN|PVN|
...
HERM HEAD lateral view
RMED
RIBL RIBR RIS VD1/DD1 VD2
RMEL/R RMEV AVL

HERM TAIL lateral view
VD11 DD6 VD13 DVB VD12 VD10 VD9 DD4 VD8 VD7 DD5 DD3 VD6 VD5 VD12 VD3 DD2 VD4 VD2 VD1/DD1

*lateral view*
unc-*47*^CRISPR::gfp
MI M4 I2 NSM RMED URX SMDV RIB AIN ASE AIY AVG RIF VD1 VD2
RMEL/R AVL RMH RIS RMEV SMDD SIAV/D
...
HERM TAIL
NeuroPAL unc-*47*^CRISPR::gfp
PDB(-) AS11(-) PVN(-) PHC(-) PLM(-)

MALE TAIL
NeuroPAL unc-*47*^CRISPR::gfp
AS11(+) PDB(+) PVN(+) PHC(+) PLM(+)

| unc-*46*^CRISPR::gfp | unc-*46*fosmid::sl2::mCherry::h2b | MERGE                         |
| ------------------------------ | -------------------------------------------- | ----------------------------- |
| HERM HEAD lateral view         | HERM HEAD lateral view                       | HERM HEAD lateral view        |
| RMED GLRD AVB                  | RMED GLRD AVB                                | RMED GLRD AVB                 |
| RIA M2                         | RIA M2                                       | CRIA                          |
| RMDVL                          | RMDVL                                        | RMDVL M2                      |
| RME GLRV AVL RIS               | RME GLRV RIB AVL RIS                         | RME GLRV RIB                  |
| RMEV RMDD                      | RMEV RMDD                                    | RMEV RMDD AVL RIS DD1 VD1 VD2 |
| HERM TAIL lateral view         | HERM TAIL lateral view                       | HERM TAIL lateral view        |
| VD12 DD6 VD13 PDA              | VD12 DD6 VD13 PDA                            | VD12 DD6 VD13 PDA             |
| DVB PVW                        | DVB PVW                                      | DVB PVW                       |
| PVN                            | PVN                                          | PVN                           |
...
| **tph-1^CRISPR::gfp** | **marker**                 | **MERGE**                                 |     |     |     |
| ------------------------------- | -------------------------- | ----------------------------------------- | --- | --- | --- |
| **HERM HEAD**                   | D/V view                   | eat-4^fosmid::sl2::mCherry::h2b |     |     |     |
| NSM                             | ADF                        | MI                                        | MI  |     |     |
| NSM                             | MI                         | ADF                                       |     |     |     |
| **HERM MIDBODY**                | vulval region ventral view | ida-1p::mCherry                           |     |     |     |
| VC4                             | HSN                        | VC4                                       | HSN | VC4 | HSN |
| VC5                             | VC5                        | VC5                                       | HSN | HSN |     |

| **bas-1^CRISPR::gfp** | **HERM HEAD**            | **HERM MIDBODY**         |     |     |     |
| ------------------------------- | ------------------------ | ------------------------ | --- | --- | --- |
| D/V view                        | D/V view                 | *PDE*                    |     |     |     |
| URB2 CEPD ADF        | HSN                      | PDE                      |     |     |     |
| NSM                             | CEPV ADE                 |                          |     |     |     |
| NSM                             | URB2 CEPD ADF | HSN                      | PDE |     |     |
| CEPV                            | CEPV                     |                          |     |     |     |
| URB2 CEPD ADE        | HSN                      | PDE                      |     |     |     |
| **NeuroPAL**                    | NSM                      | URB2 CEPD ADF | ADE | HSN | PDE |
| NSM                             | URB2 CEPD ADF | ADE                      | HSN | PDE |     |
| CEPV                            | CEPV                     |                          |     |     |     |
| **MERGE**                       | NSM                      | URB2 CEPD ADF | ADE | HSN | PDE |
| NSM                             | URB2 CEPD ADF | ADE                      | HSN | PDE |     |
| CEPV                            | CEPV                     |                          |     |     |     |

| **cat-1^CRISPR::gfp** | **HERM HEAD** | **HERM MIDBODY** |
| ------------------------------- | ------------- | ---------------- |
| lateral view                    | lateral view  |                  |
| CEPD ASI                        | CAN           |                  |
| ADF RIM RIC                     | ADE           | VC4 HSN PDE      |
| CEPV AUA                        | *VC5*         |                  |
| NSML/R RIH RIR AVL(+/-)         |               |                  |
| **NeuroPAL**                    | CEPD ASI      | CAN              |
| ADF RIM RIC                     | ADE           | VC4 HSN PDE      |
| CEPV AUA                        | *VC5*         |                  |
| NSML/R RIH RIR AVL              |               |                  |
| **MERGE**                       | CEPD ASI      | CAN              |
...
Figure 6. Expression of *tph-1/TPH*, *bas-1/AAAD*, and *cat-1/VMAT* reporter alleles in the adult hermaphrodite. (A) Dorsoventral view of a hermaphrodite head and midbody expressing *tph-1(syb6451)*. *tph-1* expression is detected robustly in the MI neuron and dimly and variably in VC4 and VC5. Neuron identities for MI and VC4 and VC5 were validated using *otls518\[eat-4(fosmid)::sl2::mCherry::h2b]* and *vsls269\[ida-1::mCherry]*, respectively, as Figure 6 continued on next page
...
Criteria for monoaminergic neurotransmitter assignment and a summary for neurons with updated identities are presented here. The categories represent our best assessments based on available data; in every category there is a possibility for the existence of non-canonical synthesis and/or uptake mechanisms that are yet to be discovered. +: presence of reporter allele expression (incl. dim); -: lack of visible reporter allele expression; *bas-1*-dependent unknown monoamine?=*bas-1*-dependent unknown monoamine (histamine, tryptamine, PEA; see **Figure 1—figure supplement 1A** and Discussion); unknown monoamine?=potentially non-canonical monoamines; see Discussion and Results sections on specific gene expression patterns; 5-HT=5-hydroxytryptamine, or serotonin; 5-HTP=5-hydroxytryptophan; PEOH = \beta-hydroxyphenethylamine, or phenylethanolamine; \*: The expression of *tph-1* in VC4-5, *bas-1* in R4B and R6B, *cat-1* in AVL, and *snf-3* in NSM, RIR, ASI, URX, M3, DVB, SMD, PDA, ASG, DA9, VA12, VB1-11, RMH, and PVV is dim and variable (this study; variability is only detected when reporter fluorescent intensity is low); anti-5-HT staining in VC4, VC5, CEM, I5, URX, and PVW (male) is variable in previous reports (see text for citations). \*\* indicates that R4B and R7B express 5-HT synthesis machinery (*tph-1* and *bas-1*), but do not stain with 5-HT antibodies.
...
|||||||||||||M3\*, AIB, DVB\*, SMD\*, RIS, PDA\*, ASG\*, DA9\*, PHC, PVN, VA12\*, VB1-11\*, RMH\*|
|Betaine (uptake)|-|-|-|-|-|-|-|+|-||PHD, PVV\*||
...
| --------------------------------------------------------- | -------------------------- | ---------------- |
| cat-2(syb8255\[cat-2::sl2::gfp::h2b]) II cat-2CRISPR::gfp | lateral view CEPD ADE CEPV | lateral view PDE |
| NeuroPAL                                                  | CEPD ADE CEPV              | PDE              |
| MERGE                                                     | CEPD ADE CEPV              | PDE              |

**B**
HERM HEAD
tdc-1(syb7768\[gfp::linker::h2b::t2a::tdc-1]) II tdc-1CRISPR::gfp | lateral view RIM RIC
NeuroPAL | RIM RIC
MERGE | RIM RIC

**C**
HERM HEAD
tbh-1(syb7786\[tbh-1::sl2::gfp::h2b]) X tbh-1CRISPR::gfp | lateral view IL2(D) IL2 IL2(V) RIC
NeuroPAL | IL2(D) IL2 IL2(V) RIC
MERGE | IL2(D) IL2 IL2(V) RIC
...
| HERMAPHRODITE                     | MALE                              |
| --------------------------------- | --------------------------------- |
| **A** mod-5^CRISPR::mNG | **B** mod-5^CRISPR::mNG |
| HEAD                              | HEAD                              |
|                                   |                                   |
| TAIL                              | TAIL                              |
|                                   |                                   |

**C** mod-5^CRISPR::mNG | **D** mod-5^CRISPR::mNG
VNC gut autofluorescence | VNC
|

**E** mod-5^CRISPR::mNG + DiD (for PHA & PHB) | **F** expression of reporter alleles in ADF | **G** anti-5-HT immunostaining in the male tail
YOUNG ADULT HERM | mod-5^CRISPR::mNG | wild type
\| mNG intensity (a.u.) |
YOUNG ADULT MALE | tph-1^CRISPR::gfp | mod-5 mutant
\| GFP intensity (a.u.) |
L4 MALE | unc-17^CRISPR::gfp |
\| GFP intensity (a.u.) |

| HERMAPHRODITE                     | MALE                              |
| --------------------------------- | --------------------------------- |
| **H** oct-1^CRISPR::gfp | **I** oct-1^CRISPR::gfp |
| HEAD                              | HEAD                              |
|                                   |                                   |
| TAIL                              | TAIL                              |
|                                   |                                   |

**J** HERMAPHRODITE | **K** oct-1^CRISPR::gfp merge with non-neuronal markers
MALE |
...
**A** snf-3^CRISPR::gfp NeuroPAL MERGE **B** snf-3^CRISPR::gfp **C** snf-3^CRISPR::gfp NeuroPAL MERGE **D** snf-3^CRISPR::gfp

HEAD
AIB RIM AIB RIM AIB RIM
AUA AUA AUA
VULVA AREA CAN
RIR RMH RIR RMH RIR RMH
SMD SMD SMD
TAIL DVB DVB DVB
snf-3^CRISPR::gfp DiD MERGE
ASI (+/-) ASI ASI
MIDBODY PDEso/sh PDE (no snf-3)
snf-3^CRISPR::gfp + NeuroPAL
PDEso/sh PDE (no snf-3)

TAIL
VA12 DA9 PDA VA12 DA9 PDA VA12 DA9 PDA
PVN PHC PVN PHC PVN PHC
snf-3^CRISPR::gfp + NeuroPAL
PVN PHC PVN PHC PVN PHC

E snf-3^CRISPR::gfp
TAIL SPso/sh somatic gonad
dorsal view ventral view

F
pan-neuronal snf-3^CRISPR::gfp HERM HEAD HERM TAIL MALE TAIL
glia glia hyp hyp hyp glia hyp glia glia
pan-neuronal
MERGE (no overlap) (no overlap) (no overlap)
...
MERGE
CA1 CA2 CA3
eat-4^CRISPR::gfp NeuroPAL MERGE
ventral view
CA7 CP7
CA7 CP7
CA7 CP7
...
unc-17^CRISPR::gfp
ventral view
CA1 CP1 CA2 CP2 CA3 CP3
NeuroPAL
CA1 CP1 CA2 CP2 CA3 CP3
MERGE
CA1 CP1 CA2 CP2 CA3 CP3
unc-17^CRISPR::gfp NeuroPAL MERGE
ventral view
CP7
CA7
CP7
...
|hline|P2-derived|P3-derived|P4-derived -derived|P5-derived|P6-derived -derived|P7-derived|P8-derived -derived|P9-derived|P10-derived|P11-derived||||
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
|CA||CA1|CA1|CA2|CA1|CA2|CA3|CA4|CA5|CA6|CA7|CA8|CA9|
|||unc-17|unc-17 7|unc-17|unc-17 7|unc-17|unc-17 7|unc-17|unc-17|unc-17||||
|||unc-47|unc-47 7|unc-47 7|unc-47 7|unc-47 7|unc-47||unc-47|||||
|||eat-4 -4|eat-4|eat-4||||eat-4 -4||||||
|CP|CP0|CP1|CP2|CP3|CP4|CP5|CP6|CP7|CP8|CP9||||
||eat-4 -4|unc-17|unc-17|unc-17|unc-17|eat-4 4|eat-4 4|unc-17|unc-17 7|||||
|||unc-47|unc-47|unc-47|unc-47|unc-47|unc-47|unc-47|unc-47|GABA(+)||||
|||5-HT(+) (+)|5-HT(+)|5-HT(+)|5-HT(+)|5-HT(+)|5-HT(+)|||||||

Figure 10. Expression of *eat-4/VGLUT* and *unc-17/VAChT* reporter alleles in the adult male. Neuronal expression of *eat-4*(syb4257) and *unc-17*(syb4491) was characterized with landmark strain NeuroPAL (*otIs696* and *otIs669*, respectively). Only selected neurons are shown to illustrate updates from previous studies. See **Supplementary file 3** for a complete list of neurons. (A) *eat-4*(syb4257) expression. Top, long panels: CA1, CA2, and CA3 show Figure 10 continued on next page
...
| -------------------------- | --------------- | --------- | -------------------------- | ------------ | --------- |
| MCM                        | MCM             | MCM       | CEMD                       | CEMD         | CEMD      |
| AMso (landmark)            | AMso (landmark) | CEMV      | CEMV                       | CEMV         |           |

| **Neuro unc-47^CRISPR PAL ::gfp** | **Neuro unc-47^CRISPR PAL** | **MERGE** |
| ------------------------------------- | ------------------------------- | --------- |
| CA1 CP1                               | CA1 CP1                         | CA1 CP1   |
| CA2 CP2                               | CA2 CP2                         | CA2 CP2   |
| CA3 CP3                               | CA3 CP3                         | CA3 CP3   |

| **Neuro unc-47^CRISPR PAL ::gfp** | **Neuro unc-47^CRISPR PAL** | **MERGE** |
| ------------------------------------- | ------------------------------- | --------- |
| CA4 CP4                               | CA4 CP4                         | CA4 CP4   |
| CA5 CP5                               | CA5 CP5                         | CA5 CP5   |
| CA6 CP6                               | CA6 CP6                         | CA6 CP6   |

| **Neuro unc-47^CRISPR PAL ::gfp** | **Neuro unc-47^CRISPR PAL** | **MERGE**       |
| ------------------------------------- | ------------------------------- | --------------- |
| CP7 CA7(-)                            | CP7 CA7                         | CP7 CA7         |
| CP8 CP9 CA8 CA9(-)                    | CP8 CP9 CA8 CA9                 | CP8 CP9 CA8 CA9 |
| R2A                                   | R2A                             | R2A             |
| R9B                                   | R9B                             | R9B             |

Figure 11. Expression of GABAergic reporter alleles in the adult male. Neuronal expression of *unc-25*(ot1372) and *unc-47*(syb7566) reporter alleles was characterized with landmark strain NeuroPAL (*otIs669*). Only selected neurons are shown to illustrate updates from previous reports. See **Supplementary file 3** for a complete list of neurons. (A) *unc-25*(ot1372) is expressed in male-specific CP9 and EF neurons as well as a few sex-shared neurons, all consistent with previous reports (**Gendrel et al., 2016**; **Serrano-Saiz et al., 2017b**). (B) *unc-47*(syb7566) shows expression in male head Figure 11 continued on next page

## Page 28

Figure 11 continued
neuron classes MCM and CEM, the former previously undetected and the latter consistent with fosmid-based reporter *otls564*. (**C**) *unc-47(syb7566)* shows expression in a number of ventral cord CA and CP neurons, largely consistent with reported *otls564* fosmid-based reporter expression except for no visible expression of *syb7566* in CA7 (due to its initial confusion with CP7, described in **Figure 10**) and presence of very dim expression in CP7. The *syb7566* reporter allele is also not visible in CA9. Scale bars, 10 μm.
...
**A MALE TAIL (dorsal)**
bas-1^CRISPR::gfp +DIC
SPso/sh
SPso/sh
cat-2^CRISPR::gfp +DIC
SPso
SPso
cat-1^CRISPR::gfp +DIC
SPso
SPso

**B MALE TAIL (lateral)**
bas-1^CRISPR::gfp pan-glial bas-1^CRISPR::gfp pan-neuronal bas-1^CRISPR::gfp (no pan-neuronal)
MERGE MERGE (no overlap)

**HERM HEAD (lateral)**
bas-1^CRISPR::gfp glia grayscale glia

**C GFP reporter allele**
tdc-1^CRISPR::gfp uv1(+) uv1(+)
cat-1^CRISPR::gfp uv1 (-) uv1 (-)
oct-1^CRISPR::gfp uv1(-) uv1(-)
...
cat-1^CRISPR::gfp +DIC seminal vesicle vas deferens
tdc-1^CRISPR::gfp +DIC vas deferens
tbh-1^CRISPR::gfp +DIC seminal vesicle vas deferens
...
**Horvitz HR**, Chalﬁe M, Trent C, Sulston JE, Evans PD. 1982. Serotonin and octopamine in the nematode Caenorhabditis elegans. Science **216**:1012–1014. DOI:
...
, PMID: 9880574
**Juge N**, Omote H, Moriyama Y. 2013. Vesicular GABA transporter (VGAT) transports \beta-alanine. Journal of Neurochemistry **127**:482–486. DOI:
...
, PMID: 24915976
**Lee RY**, Sawin ER, Chalﬁe M, Horvitz HR, Avery L. 1999. EAT-4, a homolog of a mammalian sodium-dependent inorganic phosphate cotransporter, is necessary for glutamatergic neurotransmission in Caenorhabditis elegans. The Journal of Neuroscience **19**:159–167. DOI:
...
**Saavedra JM**, Axelrod J. 1973. Demonstration and distribution of phenylethanolamine in brain and other tissues. *PNAS* **70**:769–772. DOI:

**Saavedra JM**, Ribas J, Swann J, Carpenter DO. 1977. Phenylethanolamine: a new putative neurotransmitter in Aplysia. *Science* **195**:1004–1006. DOI:

**Sarov M**, Murray JI, Schanze K, Pozniakovski A, Niu W, Angermann K, Hasse S, Rupprecht M, Vinis E, Tinney M, Preston E, Zinke A, Enst S, Teichgraber T, Janette J, Reis K, Janosch S, Schloissnig S, Ejsmont RK, Slightam C, et al. 2012. A genome-scale resource for in vivo tag-based protein function exploration in *C. elegans*. *Cell* **150**:855–866. DOI:

**Savtchouk I**, Volterra A. 2018. Gliotransmission: Beyond black-and-white. *The Journal of Neuroscience* **38**:14–25. DOI:

**Schindelin J**, Arganda-Carreras I, Frise E, Kaynig V, Longair M, Pietzsch T, Preibisch S, Rueden C, Saalfeld S, Schmid B, Tinevez J-Y, White DJ, Hartenstein V, Eliceiri K, Tomancak P, Cardona A. 2012. Fiji: an open-source platform for biological-image analysis. *Nature Methods* **9**:676–682. DOI:

**Schuske K**, Palfreyman MT, Watanabe S, Jorgensen EM. 2007. UNC-46 is required for trafficking of the vesicular GABA transporter. *Nature Neuroscience* **10**:846–853. DOI:

**Serrano-Saiz E**, Poole RJ, Felton T, Zhang F, De La Cruz ED, Hobert O. 2013. Modular control of glutamatergic neuronal identity in *C. elegans* by distinct homeodomain proteins. *Cell* **155**:659–673. DOI:

**Serrano-Saiz E**, Oren-Suissa M, Bayer EA, Hobert O. 2017a. Sexually dimorphic differentiation of a *C. elegans* Hub Neuron is cell autonomously controlled by a conserved transcription factor. *Current Biology* **27**:199–209. DOI:

**Serrano-Saiz E**, Pereira L, Gendrel M, Aghayeva U, Bhattacharya A, Howell K, Garcia LR, Hobert O. 2017b. A neurotransmitter atlas of the *Caenorhabditis elegans* male nervous system reveals sexually dimorphic neurotransmitter usage. *Genetics* **206**:1251–1269. DOI:

**Serrano-Saiz E**, Vogt MC, Levy S, Wang Y, Kaczmarczyk KK, Mei X, Bai G, Singson A, Grant BD, Hobert O. 2020. SLC17A6/7/8 vesicular glutamate transporter homologs in nematodes. *Genetics* **214**:163–178. DOI:

**Shaffer JM**, Greenwald I. 2022. Floxed exon (Flexon): A flexibly positioned stop cassette for recombinase-mediated conditional gene expression. *PNAS* **119**:e2117451119. DOI:

**Sulston J**, Dew M, Brenner S. 1975. Dopaminergic neurons in the nematode *Caenorhabditis elegans*. *The Journal of Comparative Neurology* **163**:215–226. DOI:

**Sulston JE**, Albertson DG, Thomson JN. 1980. The *Caenorhabditis elegans* male: postembryonic development of nongonadal structures. *Developmental Biology* **78**:542–576. DOI:

**Sze JY**, Victor M, Loer C, Shi Y, Ruvkun G. 2000. Food and metabolic signalling defects in a *Caenorhabditis elegans* serotonin-synthesis mutant. *Nature* **403**:560–564. DOI:

**Taylor SR**, Santpere G, Weinreb A, Barrett A, Reilly MB, Xu C, Varol E, Oikonomou P, Glenwinkel L, McWhirter R, Poff A, Basavaraju M, Rafi I, Yemini E, Cook SJ, Abrams A, Vidal B, Cros C, Tavazoie S, Sestan N, et al. 2021. Molecular topography of an entire nervous system. *Cell* **184**:4329–4347. DOI:

**Tekieli T**, Yemini E, Nejatbakhsh A, Wang C, Varol E, Fernandez RW, Masoudi N, Paninski L, Hobert O. 2021. Visualizing the organization and differentiation of the male-specific nervous system of *C. elegans*. *Development* **148**:dev199687. DOI:

**Tiveron M-C**, Beurrier C, Céni C, Andriambao N, Combes A, Koehl M, Maurice N, Gatti E, Abrous DN, Kerkerian-Le Goff L, Pierre P, Cremer H. 2016. LAMP5 fine-tunes GABAergic synaptic transmission in defined circuits of the mouse brain. *PLOS ONE* **11**:e0157052. DOI:

**Vidal B**, Gulez B, Cao WX, Leyva-Díaz E, Reilly MB, Tekieli T, Hobert O. 2022. The enteric nervous system of the *C. elegans* pharynx is specified by the Sine oculis-like homeobox gene *ceh-34*. *eLife* **11**:e76003. DOI:

**Wallace ML**, Sabatini BL. 2023. Synaptic and circuit functions of multitransmitter neurons in the mammalian brain. *Neuron* **111**:2969–2983. DOI:

**White JG**, Southgate E, Thomson JN, Brenner S. 1986. The structure of the nervous system of the nematode *Caenorhabditis elegans*. *Philosophical Transactions of the Royal Society of London. Series B, Biological Sciences* **314**:1–340. DOI:

**Witvliet D**, Mulcahy B, Mitchell JK, Meirovitch Y, Berger DR, Wu Y, Liu Y, Koh WX, Parvathala R, Holmyard D, Schalek RL, Shavit N, Chisholm AD, Lichtman JW, Samuel ADT, Zhen M. 2021. Connectomes across development reveal principles of brain maturation. *Nature* **596**:257–261. DOI:

**Yang H**, Kunes S. 2004. Nonvesicular release of acetylcholine is required for axon targeting in the *Drosophila* visual system. *PNAS* **101**:15213–15218. DOI:

## Page 46

**Yemini E**, Lin A, Nejatbakhsh A, Varol E, Sun R, Mena GE, Samuel ADT, Paninski L, Venkatachalam V, Hobert O. 2021. NeuroPAL: A multicolor atlas for whole-brain neuronal identification in *C. elegans*. **Cell** **184**:272–288. DOI:

**Yu J**, Vogt MC, Fox BW, Wrobel CJJ, Fajardo Palomino D, Curtis BJ, Zhang B, Le HH, Tauffenberger A, Hobert O, Schroeder FC. 2023. Parallel pathways for serotonin biosynthesis and metabolism in *C. elegans*. Nature Chemical Biology **19**:141–150. DOI:

**Zhu C**, Nigam KB, Date RC, Bush KT, Springer SA, Saier MH, Wu W, Nigam SK. 2015. Evolutionary analysis and classification of OATs, OCTs, OCTNs, and other SLC22 transporters: structure-function implications and analysis of sequence motifs. PLOS ONE **10**:e0140569. DOI:
