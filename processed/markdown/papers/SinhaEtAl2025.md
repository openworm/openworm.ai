...
**a.**
\[Diagram showing a cell membrane with ion channels and Na^+ ions passing through.]

**b.**
\[Diagram showing two morphologically detailed neurons, one in red and one in blue.]

**c.**
\[Diagram showing a complex network of interconnected neurons in green, red, and blue.]

**Conductances**
\[Diagram showing hierarchical blocks: gate 1, gate 2, gate 3 connected to a larger gate structure.]

**Cells**
\[Diagram showing hierarchical blocks: morph1 and morph2 connected to cell structures.]

**Networks**
\[Diagram showing hierarchical blocks: pop 1, projection, and pop 2 representing network components.]
...
|Life Cycle Stage|Core NeuroML Tools (Inner Circle)|NeuroML-compliant Tools (Outer Layer)|
|-|-|-|
...
|Reuse|pyNeuroML|NeuroMorpho.OrgOSBNeuroML-DB|
...
|...||
|Share and archive||
|create\_combine\_archive("sim.xml")|> pynml-archive "neuron.cell.nml"|
...
**a.**
The image shows an interactive 3-D visualization of an olfactory bulb network with detailed mitral and granule cells, featuring a complex web of colorful neuronal morphologies (blue, green, red, and purple lines) interconnected in a spherical arrangement.

|OPEN SOURCE BRAIN|search projects|Q|My Projects ▾|Explore OSB|Help|Admin|sanjay\_ankur ▾|
|-|-|-|-|-|-|-|-|
|MultiscaleISN|⟲ Return to project \[Troubleshoot 3D explorer]|||||||
|Connectivity Model Description Results ⚙ Run ▶ Play ⏸ Pause ◼ Stop 🛈 Help||||||||

The image displays a 3D visualization within the Open Source Brain (OSB) version 1 interface, showing an inhibition stabilized network with numerous red and blue spherical nodes representing neurons and green branching structures representing their dendritic/axonal processes.

|Open Source Brain v2.0|padraig|padraig|padraig|padraig|padraig|padraig|padraig|
|-|-|-|-|-|-|-|-|
|+ NetPyNE|File|View|Model|Examples|Help|BACK TO EDIT|SIMULATE ▾|

The image shows the NetPyNE GUI embedded in OSB version 2. It includes:

* A **3D Representation** panel showing white branching neuronal morphologies with highlighted segments in orange and green.
...
* A **Raster plot** panel showing spiking activity (dots) for different cells (ordered by gid) over time (0-200 ms).
...
|presynaptic \ postsynaptic|HL23PV\_pop|HL23PYR\_pop|HL23SST\_pop|HL23VIP\_pop|
|-|-|-|-|-|
|HL23PV\_pop|10000|10000|10000|10000|
|HL23PYR\_pop|20000|70000|25000|10000|
|HL23SST\_pop|10000|30000|10000|10000|
|HL23VIP\_pop|10000|0|30000|10000|

*Note: Values are estimated from the color scale provided in the figure (0 to 70000).*
...
Search | Gallery | API | Documentation | About | NeuroML Home

**Layer 5b Pyramidal cell**
\[ Overview ] \[ Electrophysiology ] \[ Morphology ] \[ Computational Complexity ]

**Current Clamp Response**
Protocol: \[ Square (Long) ] Stimulus: **ALL**

| Time (ms)   | Voltage (mV) (approx. range)         |
| :---------- | :----------------------------------- |
| 0 - 1000    | -80                                  |
| 1000 - 3000 | Spiking activity between -80 and +40 |
| 3000 - 3250 | -80                                  |

| Time (ms)   | Current (nA) (approx. levels)          |
| :---------- | :------------------------------------- |
| 0 - 1000    | 0.0                                    |
| 1000 - 3000 | Four steps: \~0.4, \~0.6, \~0.8, \~1.0 |
| 3000 - 3250 | 0.0                                    |

|Membrane potential (mV)|Steady state - inf (na\_channel m inf)|Steady state - inf (na\_channel h inf)|
|-|-|-|
|-100|0.0|1.0|
|-50|0.2|0.2|
|0|0.9|0.0|
...
|Membrane potential (mV)|Time Course - tau (ms) (na\_channel m tau)|Time Course - tau (ms) (na\_channel h tau)|
|-|-|-|
|-100|\~0.1|\~1.0|
|-70|\~0.2|\~8.5|
|-50|\~0.4|\~4.0|
...
The image shows a visualization of a Layer 5 Pyramidal cell where the color of the neurites represents the peak conductance for the Ih channel (S/m^2).

* **x-axis:** x (\mu m) ranging from -200 to 1200.
* **y-axis:** y (\mu m) ranging from -200 to 100.
* **Color Scale (S/m^2):**
  * Purple/Blue: \~20
  * Pink/Red: \~60-80
  * Orange/Yellow: \~100-140 (primarily in the distal apical dendrites).
...
Sinha, Gleeson et al. eLife 2024;13:RP95135. DOI: [https://doi.org/10.7554/eLife.95135](https://doi.org/10.7554/eLife.95135) 21 of 44
...
**b.**
The image shows a line graph of membrane potential (V) over time (s). The graph displays regular bursting activity, with clusters of rapid spikes followed by quiescent periods. The membrane potential oscillates between approximately -0.06 V and 0.06 V.
...
**Gleeson P, Sinha A.** 2024. NeuroML 2. swh:1:rev:50aacc6f0b97cf4a70f6887d4beb6b3b67c32eb6. Software Heritage.
